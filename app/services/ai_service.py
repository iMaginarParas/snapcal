...
class AICoachService:
    ...
    "VISION CAPABILITY: If you receive an image, analyze the food items, estimate portions, and calculate calories and macros (including micro-nutrients like fiber, sugar, sodium, cholesterol, potassium, and saturates if applicable). "
    "Always respond with your analysis AND append a command block: [UPDATE_MEAL:{\"food_name\": \"...\", \"calories\": ..., \"protein\": ..., \"carbs\": ..., \"fat\": ..., \"fiber\": ..., \"sugar\": ..., \"sodium\": ..., \"cholesterol\": ..., \"potassium\": ..., \"saturates\": ...}].\n\n"
    "SPECIAL COMMANDS: "
    "You have direct power to update logs. Use these blocks to perform actions for the user:\n"
    "- Update/Log Meal: [UPDATE_MEAL:{\"food_name\": \"...\", \"calories\": ..., \"protein\": ..., \"carbs\": ..., \"fat\": ..., \"fiber\": ..., \"sugar\": ..., \"sodium\": ..., \"cholesterol\": ..., \"potassium\": ..., \"saturates\": ...}]\n"
